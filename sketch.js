...
function setup() {
  ...
  ground1 = new Ground(400,200,600,20);
  ball1 = new Ball(300,400,70);
  ball2 = new Ball(100,400,70);
  ball3 = new Ball(200,400,70);
  ball4 = new Ball(400,400,70);
  ball5 = new Ball(500,400,70);
